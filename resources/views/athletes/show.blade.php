<x-app-layout title="Información del Atleta">
    ...
    @if ($athlete->user->role_id == 3)<div class="row">
        <div class="col mb-3">
            <div class="row">
                <div class="col">
                ...
                @if ($athlete->user->role_id != 3)<div class="row">
                    <div class="col mb-3">
                        <div class="row">
                            ...
                            @can('role', ['Admin'])<div class="col d-flex justify-content-end">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="medical_opinion" class="col-sm-4 col-lg-12 col-form-label">Número de Dictamen
                                                Médico</label>
                                            <div class="col-sm-8 col-lg-12">
                                                <x-input disabled name="medical_opinion" value="{{ $athlete->medical_opinion }}" />
                                            </div>
                                        </div>
