...
<body class="athletes">
    ...
    <div class="container">
        ...
        <div class="arrows py-1 row justify-content-center">
                                ...
                                <div class="">
                                    <div class="card-header" id="headingOne">
                                        <h2 class="text-center mb-0">
                                            <button class="boton_datos text-center btn btn-link btn-block" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            Desplegar Formulario
                                            </button>
                                        </h2>
                                    </div>

                                    <div id="collapseOne" class="mt-2 collapse hide" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="">
                                                        <!-- Mensaje de encargado -->

                                        <h3 class="d-5 text-center">
                                            Datos del Encargado
                                        </h3>
                                            <x-row>
