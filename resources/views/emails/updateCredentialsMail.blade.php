...
<div>
    <hr>
    <h1 class="mensaje">Actualización de Datos</h1>
    <hr>
...
<hr>
<div class="mensaje">
    <h1 class="mensaje">Datos Actualizados</h1>
</div>
<hr>
...
| ------------- |:-------------:|
<p class="mensaje"><?php echo   $datos['Id'] ?></p> | <p class="mensaje"><?php echo $datos['Password'] ?></p>
@endcomponent
