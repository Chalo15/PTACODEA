...
class PhysioConfirmMail extends Mailable
{
    ...
    {
        return [
            'Id_Instructor' => $this->appointment->athlete->user->identification,
            'Nombre_Instructor' => $this->appointment->athlete->user->name,
            'Apellidos_Instructor' => $this->appointment->athlete->user->last_name,
